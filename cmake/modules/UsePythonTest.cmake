...
if(NOT Python3_EXECUTABLE)
  ...
  MESSAGE("NO Python3_EXECUTABLE FOUND")
  return()
...
"
  ...
  MESSAGE(\"${pyenv}\")
  EXECUTE_PROCESS(
        COMMAND ${Python3_EXECUTABLE} ${loc} ${wo_semicolumn}
...
MACRO(ADD_PYTHON_COMPILEALL_TEST DIRNAME)
  ...
  ADD_TEST(COMPILE_ALL-${DIRNAME} ${Python3_EXECUTABLE} "${PYTHON_COMPILE_ALL_PY}" -q ${DIRNAME})
